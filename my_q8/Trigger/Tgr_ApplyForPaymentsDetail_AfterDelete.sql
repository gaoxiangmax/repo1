...
*/
delimiter $
 drop trigger if exists Tgr_ApplyForPaymentsDetail_AftereDelete $
 create trigger Tgr_ApplyForPaymentsDetail_AftereDelete after delete
 on ApplyForPaymentsDetail 
 for each row
 begin
    declare sKeyModaul varchar(255);
    declare sKeyNo varchar(255);
    set sKeyModaul=old.KeyModaul;
