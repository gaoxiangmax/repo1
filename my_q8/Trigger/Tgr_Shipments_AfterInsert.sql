...
*/
delimiter $
drop trigger if exists Tgr_Shipments_AftereInsert $
create trigger Tgr_Shipments_AftereInsert after insert
on Shipments 
for each row
begin
    /*定义变量*/
    ...
    call Proc_Shipments_TotalShipments(sCustomerNo);-- 结算中心-出货总额
end$
delimiter ;