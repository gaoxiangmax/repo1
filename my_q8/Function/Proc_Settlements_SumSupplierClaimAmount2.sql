...
*/
delimiter $ 
drop procedure if exists Proc_Settlements_SumSupplierClaimAmount2 $
create procedure Proc_Settlements_SumSupplierClaimAmount2(sInvoiceNO varchar(255),sKeyNo varchar(255)) 
begin
