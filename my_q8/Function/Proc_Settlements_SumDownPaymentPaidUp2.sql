...
*/
delimiter $ 
drop procedure if exists Proc_Settlements_SumDownPaymentPaidUp2 $
create procedure Proc_Settlements_SumDownPaymentPaidUp2(sInvoiceNO varchar(255),sKeyNo varchar(255)) 
begin
