...
*/
delimiter $ 
drop procedure if exists Proc_Shipments_SumBilledAmount $
create procedure Proc_Shipments_SumBilledAmount(srid varchar(255),sPurchaseOrderNo varchar(255),sItemNo varchar(255),sSOL_RecordID varchar(255)) 
begin
