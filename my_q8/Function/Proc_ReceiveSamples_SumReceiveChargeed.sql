...
*/
delimiter $ 
drop procedure if exists Proc_ReceiveSamples_SumReceiveChargeed $
create procedure Proc_ReceiveSamples_SumReceiveChargeed(srid varchar(255),sKeyNo varchar(255)) 
begin
