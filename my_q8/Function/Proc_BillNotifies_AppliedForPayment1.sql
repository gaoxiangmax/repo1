...
*/
delimiter $ 
drop procedure if exists Proc_BillNotifies_AppliedForPayment1 $
create procedure Proc_BillNotifies_AppliedForPayment1(sKeyNo varchar(255)) 
begin
    ...
    Update BillNotifies set AppliedForPayment = fAppliedForPayment,UnAppliedForPayment=(ifnull(TotalBillAmount,0)-fAppliedForPayment) Where BillNotifies.BillNotifyNo=sKeyNo;
end $ 
delimiter ;